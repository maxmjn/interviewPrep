...
//                                +response
//                                +'</code></pre>');
                         $('#create-data ul').empty();//clear any children before adding
                         $('#create-data ul')
                          .append(
                        ...
                        case 'search':
                          ...
                          $(searchTable).empty(); //clear any children before adding
                          var userId = data.id;
                          //header
                          $(searchTable)
                          .addClass("table_1")
                        ...
                        case 'getUsers':
                          ...
                          $(userTable).empty();//before adding, empty child elements if any
