...
public class EntityHelper {
   ...
   * @return
   */
  public static List<AlbumDao> getAlbumDao(List<Album> albums){
   ...
   * @return
   */
  public static List<PhotoDao> getPhotoDao(List<Photo> photos){
    List<PhotoDao> photoDaoList = new LinkedList<>();
    for(Photo photo:photos){
      PhotoDao photoDao = new PhotoDao();
      BeanUtils.copyProperties(photo, photoDao, "");
